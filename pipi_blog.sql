...
-- ----------------------------
BEGIN;
INSERT INTO `pp_article_tag` VALUES ('20', '1', '2'), ('21', '1', '5'), ('22', '1', '9'), ('24', '3', '2'), ('25', '3', '11'), ('26', '2', '10');
COMMIT;
...
CREATE TABLE `pp_category` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '是否删除0-正常，1-删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='栏目分类表';

-- ----------------------------
--  Records of `pp_category`
-- ----------------------------
BEGIN;
INSERT INTO `pp_category` VALUES ('1', '编程语言', '0', '1', '1', 'PHP、Go等WEB编程语言技术分享', '这里介绍的是编程语言的分享', '1524148865', '0', '0'), ('2', '数据库', '0', '1', '2', 'Mysql,Redis等主流数据库使用分享', 'Mysql,Redis等主流数据库使用分享', '1524148908', '0', '0'), ('3', '算法&架构', '0', '1', '3', '常见算法和架构学习', '常见算法和架构学习', '1524148950', '0', '0'), ('4', '学习点滴', '0', '1', '4', '学习点滴', '学习点滴', '1524148993', '0', '0'), ('5', '开源项目', '0', '1', '5', '开源项目', '开源项目', '1524193518', '0', '0');
COMMIT;
